---
day: 1
title: Arrival · Kamogawa Delta · Higashiyama
date: 2026-11-13
location: KIX → Kyoto
...
timeline:
  - time: "07:20"
    stop: KIX Arrival — TG622 จาก BKK (อาคาร 1)
    cost: "—"
...
references:
  ...
  - title: Kyoto City Bus — 1-day pass ¥700
    ...
    icon: 🚌
  - title: Kamogawa Delta — Kyoto Prefectural Kamogawa Park
    url: https://www.tripadvisor.com/Attraction_Review-g298564-d7987108-Reviews-Kamogawa_Delta_Kyoto_Prefectural_Kamogawa_Park.html
    icon: 🌊
  - title: Demachi Futaba — Kyoto's most famous mochi shop
...
<div class="callout">
  <strong>✅ จองแล้ว — Hotel Keihan Kyoto Ekiminami</strong>
  <ul>
    <li><strong>วันเข้าพัก:</strong> 13 พ.ย. 2026 (1 คืน) · check-in 15:00 · check-out ก่อน 11:00</li>
    <li><strong>ห้อง:</strong> Standard Twin · เตียงเดี่ยว 2 เตียง · 2 ผู้ใหญ่</li>
    <li><strong>Breakfast:</strong> WESTERN buffet style · รวมในราคาห้อง (2 คน, เช้า 14 พ.ย.)</li>
    <li><strong>ราคา:</strong> ฿6,998.88 (จ่ายแล้ว)</li>
    <li><strong>ที่อยู่:</strong> 55 Higashikujyo-Muromachi, Minami Ward, 601-8001 Kyoto · ฝั่งใต้ Kyoto Station (Hachijo) เดิน 7 นาที</li>
    <li>🛁 <strong>大浴場 + sauna</strong> · เปิดถึงดึก · แช่อ่างก่อนนอน reset jet-lag</li>
    <li>🍳 <strong>Takeout option:</strong> หยิบ breakfast ใส่ขวดไปกินบน train ก็ได้ — ใช้ Day 2 ออกบามบูเช้าก่อนคน</li>
  </ul>
</div>
...
ข้ามแม่น้ำได้แบบกระโดด — ไม่บังคับ ไม่อยากข้ามก็เดินตลิ่ง ดูคนอื่นข้ามก็ได้ภาพดี
...
14:30 ขึ้น **Keihan Line** จาก Demachiyanagi → Gion-Shijo (6 นาที, ¥220) · เดิน
ขึ้น Yasaka Shrine 10 นาที (ไวกว่าและไม่ติด traffic เหมือนบัส)
ช่วง 14:30–17:30 เก็บ 3 ไอคอนหลักเฉพาะ ไม่ลุยเก็บทุกวัด:
