...
timeline:
  ...
  - time: "08:00–08:30"
    ...
    cost: "—"
    transit: 🚶 JR Ticket Office ที่ KIX · refund ICOCA = ¥220 deposit + balance คืน · Customs counter โชว์ tax-free purchase
  - time: "08:30–10:30"
    stop: TG623 Check-in + Immigration + Security
    cost: "—"
    transit: 🛂 Terminal 1 · เคาน์เตอร์ Thai Airways เปิด ~3 ชม.ก่อนบิน
  - time: "10:30–11:00"
    stop: Boarding gate + last duty-free
    cost: "TBD"
    transit: 🛍️ Tokyo Banana / Royce / Donguri Republic · ดื่มน้ำให้หมดก่อนขึ้นเครื่อง
  - time: "11:00"
    stop: TG623 KIX → BKK (ถึง 15:45)
    cost: "—"
    transit: ✈️ Thai Airways · A350-900 · บินตรง 6h 45m · เสิร์ฟอาหาร 1 มื้อ
coords:
...
references:
  ...
  - title: Thai Airways TG623 — flight status
    ...
    icon: ✈️
tags: [osaka2026, osaka, kix, departureday, haruka, tg623, thaiairways]
---

เช้าสุดท้าย กระเป๋าหนักขึ้น — และทริปก็จบที่เดิมกับที่ทุกทริปคันไซจบ:
กลับมาที่ **สนามบินคันไซ**

<div class="callout">
  <strong>📋 Day 5 — ของที่ลืมง่าย</strong>
  <ul>
    <li><strong>🏪 Konbini breakfast</strong> — โรงแรมญี่ปุ่น breakfast เริ่ม 06:30 → เราออก 06:30 พอดี ก็ไม่ทัน · แวะ Lawson / Family Mart ในสถานี Umeda แทน (onigiri + กาแฟ ¥500)</li>
    ...
    <li><strong>✈️ TG623 เสิร์ฟอาหาร 1 มื้อ</strong> — กินบนเครื่องได้ ไม่ต้องโหลด lunch · มี vegetarian meal ถ้าระบุล่วงหน้า</li>
    <li><strong>🛍️ Duty-free</strong> หลัง security: Donguri Republic (Ghibli), Tokyo Banana, Royce, Pablo · ราคาเท่ากับ/ถูกกว่าในเมือง</li>
  </ul>
</div>

## ขั้นตอนเช้า

ตื่นก่อน 05:30 เช็คเอาต์ หยิบของหน้า front desk แล้วเดินไป Osaka Station
แวะ **Konbini ในสถานี (24/7)** ซื้อ onigiri + กาแฟ — กินบน Haruka ได้สบาย
ขึ้น **JR Haruka** เที่ยว 07:00 ตรงไปสนามบินคันไซ — 50 นาที direct
ถึง KIX ราว 07:50 เผื่อเวลา ~3 ชั่วโมงก่อน **TG623** ออก 11:00
...
- 🍫 **Royce / Tokyo Banana / Glico Pocky** — classic chocolate omiyage
- 🥟 **551 Hourai pork buns** — กิน fresh ภายใน 4 ชม. · ฝากใครต้องเตรียมรับเลย
- 🧁 **Pablo cheese tart** — refrigerated
- 🍪 **Kit Kat รสญี่ปุ่นพิเศษ** (matcha, sake, yuzu) — ที่นี่หาง่ายกว่าในเมือง
- 🎨 **Donguri Republic (Ghibli)** — Totoro figurine · ของเก็บ

## ปิดทริป

ห้าวันสองคน เกียวโตเปิดทริปด้วยวัด อาราชิยามะ Katsuoji-Akashi
