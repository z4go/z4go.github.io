...
status: planning
tags: [osaka2026, kansai, kyoto, osaka]
preplan:
  checklist:
    - label: Flight TG622 — BKK 23:59 (12 Nov) → KIX 07:20 (13 Nov)
      status: done
      note: Thai Airways · A350-900 · 5h 21m
    - label: Flight TG623 — KIX 11:00 → BKK 15:45 (17 Nov)
      status: done
    ...
    - label: eSIM purchase — Klook/Saily/Airalo
      status: todo
      note: ฿200-400 สำหรับ 5-7 วัน · เปิดใช้ตอน landing KIX · backup ซื้อที่ KIX counter ¥2,000
    - label: 📱 Apps download ก่อนบิน
      status: todo
      note: USJ official (Power-Up Band + ride times) + Google Maps offline Kansai + Google Translate JP pack + Klook/KKday + TG Mobile (online check-in 24 ชม.ก่อนบิน)
